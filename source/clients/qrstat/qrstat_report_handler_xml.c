...
qrstat_report_start(qrstat_report_handler_t* handler, lList **alpp) 
{
   ...
   sge_dstring_append(buffer, "<qrstat xmlns:xsd=\"http://gridscheduler.svn.sourceforge.net/viewvc/gridscheduler/trunk/source/dist/util/resources/schemas/qrstat/qrstat.xsd?revision=11\">\n");
